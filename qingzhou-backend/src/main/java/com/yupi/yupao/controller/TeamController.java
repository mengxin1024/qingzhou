...
@RestController
@RequestMapping("/team")
//@CrossOrigin(origins = {"https://114.55.130.173:5173"})
...
//        return ResultUtils.success(resultPage);
    ...
    @PostMapping("/delete")
    public BaseResponse<Boolean> deleteTeam(@RequestBody DeleteTeamRequest deleteRequest, HttpServletRequest request) {
